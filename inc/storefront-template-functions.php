...
if ( ! function_exists( 'storefront_page_content' ) ) {
	...
	function storefront_page_content() {
		...
		<div class="entry-content">
            ...
            if ($product_sections && in_array('popular', $product_sections) ) {
	            echo do_shortcode( '[best_sellers]' );
            }
...
if ( ! function_exists( 'storefront_primary_navigation_wrapper' ) ) {
	...
	function storefront_primary_navigation_wrapper() {
		echo '<div class="storefront-primary-navigation"><div>';
            ...
            <div class="categories-menu categories-slide_js swiper">
                <?php ib_display_categories_menu(); ?>
            </div>
                <?php }
}
